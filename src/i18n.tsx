...
export type Catalog = {
  ...
  home: {
    ...
    madeBy: string; makersTitle: string; makersDescription: string; creatorRole: string; testerRole: string
...
const en: Catalog = {
  ...
  home: {
    ...
    madeBy: 'MADE BY', makersTitle: 'A small team, serious levels', makersDescription: 'Created by 快乐mario9 with Thunder Engine, with 绿色的糖果 contributing to level design and testing.', creatorRole: 'Level creator · Producer', testerRole: 'Level creator · Testing', ready: 'READY PLAYER?', ctaTitle: 'Start your Reforged journey', currentVersion: 'Current version V0.8.0 · Updated 2026.07.22', getGame: 'Get the game',
  },
  worlds: {
    eyebrow: 'LEVEL ARCHIVE / 01', title: 'Eight worlds, thirty-two destinations', description: 'Level names follow the original HMW template. Difficulty does not rise in a straight line, so explore each world at your own pace.', select: 'WORLD SELECT', completed: '32 / 32 COMPLETE', selected: 'SELECTED', ready: 'READY', levels: 'LEVELS', current: 'CURRENTLY SELECTED', currentDescription: 'Contains {levels} main levels. Actual difficulty does not perfectly match the world number, so enter the challenge whenever you are ready.', bonus: 'BONUS STAGE', bonusTitle: 'There is one hidden route', bonusDescription: 'V0.8.0 adds the extra level <b>synthetic roto wave</b>, the first PKMF8 round. It sits outside the eight main worlds.', extra: 'EXTRA', round: 'PKMF8 / ROUND 01', items: [
      { theme: 'Grassland Starting Point', note: 'World 1 · Basic levels' }, { theme: 'Pipes and Pathfinding', note: 'World 2 · Use bullets to scout ahead' }, { theme: 'Castle Frontline', note: 'World 3 · Includes a castle destruction cutscene' }, { theme: 'After the Cutscene', note: 'World 4 · Includes a bonus level' }, { theme: 'Advanced Journey', note: 'World 5 · Improved entrance cutscene' }, { theme: 'Ice Floor Trial', note: 'World 6 · Completion animation tweaks' }, { theme: 'High-Pressure Zone', note: 'World 7 · 7-4 has been toned down' }, { theme: 'Final Frontline', note: 'World 8 · Added in V0.8.0' },
    ],
  },
  releases: {
